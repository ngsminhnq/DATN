...
namespace HRemployee.Migrations
{
    ...
    [Migration("20260407044221_AddContracts")]
...
#pragma warning disable 612, 618
            modelBuilder.HasAnnotation("ProductVersion", "8.0.25").HasAnnotation("Relational:MaxIdentifierLength", 63);
            ...
            modelBuilder.Entity("HRemployee.Entities.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = 1,
                            EndDate = new DateTime(2028, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            SalaryPercent = 100,
                        ...
                        new
                        {
                            Id = 4, ContractCode = "HD004", ContractType = 3, CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), EmployeeId = 4, EndDate = new DateTime(2028, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), SalaryPercent = 100, StartDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), Status = 1 });
                });
