...
namespace HRemployee.Migrations
{
    ...
    [Migration("20260406091050_InitialCreate")]
            ...
            modelBuilder.Entity("HRemployee.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1, CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), DepartmentId = 1, Email = "director@company.com", EmployeeCode = "NV001", FullName = "Giám Đốc", HireDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), IsDeleted = false, PositionId = 1, Status = 1 });
                });
            ...
            modelBuilder.Entity("HRemployee.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1, CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), Email = "director@company.com", EmployeeId = 1, IsActive = true, Password = "$2a$12$umDEKg3yORpv174r7kzKxO7Z.BVbw0HDzb44jCsvgjHGGn5rM6/Ky", RoleId = 1, Username = "director" });
                });
